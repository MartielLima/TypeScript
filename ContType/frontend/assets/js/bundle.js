...
/***/ "./src/webpack/register/form-control.ts":
/*!**********************************************!*\
  !*** ./src/webpack/register/form-control.ts ***!
  \**********************************************/
...
function throwsError(element, text) {
    const error = document.createElement('span');
    error.classList.add('error-message');
    error.innerText = text;
    const myParent = element.parentElement;
    removeError(element);
...
function removeError(element) {
    ...
    if (myParent)
        myParent.classList.remove('show-error-message');
}
function validatePassword() {
    if (!password.value)
        throwsError(password, 'A senha deve ser informada.');
...
function validatePassword2() {
    if (!password2.value)
        throwsError(password2, 'A senha deve ser informada.');
...
function validateEmail() {
    if (!email.value)
        throwsError(email, 'O e-mail deve ser informado.');
    else if (!(0, isEmail_1.default)(email.value))
        throwsError(email, 'E-mail invalido!');
    else
        removeError(email);
}
function validateUsername() {
    if (!username.value)
        throwsError(username, 'Deve ser informado usuario.');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./register/form-control */ "./src/webpack/register/form-control.ts");
